...
export function ResponsiveDropdownV2({ dropdownLabel, items }: ResponsiveDropdownV2Props) {
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  item.variant === "destructive" ? "text-red-400 hover:bg-red-700/20" : "text-slate-100 hover:bg-slate-800",
